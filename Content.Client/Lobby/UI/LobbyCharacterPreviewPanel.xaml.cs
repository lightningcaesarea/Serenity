...
/* Starlight - removed references
using Content.Client.UserInterface.Controls;
*/// End of removed references
...
public sealed partial class LobbyCharacterPreviewPanel : Control
{
    ...
    private KinkListWindow? _kinkWindow;
    ...
    public LobbyCharacterPreviewPanel()
    {
        ...
        KinkListButton.OnPressed += _ => OpenKinkWindow();
    }

    private void OpenKinkWindow()
    {
        if (_kinkWindow == null || _kinkWindow.Disposed)
        {
            _kinkWindow = new KinkListWindow(_preferences, _prototypeManager);
            _kinkWindow.OpenCentered();
        }
        else
        {
            _kinkWindow.MoveToFront();
        }
    }
