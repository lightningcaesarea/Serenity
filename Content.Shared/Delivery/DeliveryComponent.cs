...
public sealed partial class DeliveryComponent : Component
{
    ...
    /// <summary>
    /// The base amount of Federal Bills that gets added to the station bank account on unlock.
    /// </summary>
    [DataField, AutoNetworkedField]
    public int BaseSpesoReward = 500;

    /// <summary>
    /// The base amount of Federal Bills that will be removed from the station bank account on a penalized delivery
    /// </summary>
    [DataField, AutoNetworkedField]
