...
cargo-console-fund-withdraw-broadcast = [bold]{$name} withdrew {$amount} Federal Bills from {$name1} \[{$code1}\]
cargo-console-fund-transfer-broadcast = [bold]{$name} transferred {$amount} Federal Bills from {$name1} \[{$code1}\] to {$name2} \[{$code2}\][/bold]
