...
tamper-seal-popup-unseal-end-reward = Seal opened. {$deliverer} is awarded {$reward} Federal Bills.
...
tamper-seal-popup-destroy-end-penalty = Seal broken! {$deliverer} fined {$penalty} Federal Bills. Refund provided.
